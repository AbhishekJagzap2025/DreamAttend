...
//   void initState() {
//     super.initState();
//     // Run update check after the first frame is built
...
//   // /// 🔔 Check for updates and show banner under AppBar for 5 seconds
...
//   //   final installedVersionOnly = packageInfo.version;
//   //   final storeVersion = upgrader.currentAppStoreVersion();

//   //   debugPrint(
//   //       "📱 Installed Version: $installedVersionOnly, Store Version: $storeVersion");

//   //   if (storeVersion != null && upgrader.shouldDisplayUpgrade()) {
...
//   //         ),
//   //         leading: const Icon(Icons.system_update, color: Colors.black),
//   //         actions: [
//   //           TextButton(
//   //             onPressed: () {
//   //               upgrader.onUserUpdated(context, true); // opens store
...
//   //           TextButton(
//   //             onPressed: () {
//   //               messenger.hideCurrentMaterialBanner(); // dismiss banner
//   //             },
//   //             child: const Text(
//   //               'Cancel',
//   //               style:
...
//       showDialog(
//         context: context,
//         barrierDismissible: false, // user must choose Update or Cancel
//         builder: (context) {
//           return AlertDialog(
...
//     if (widget.groups.contains('dm_employee.group_hr_admin') ||
//         widget.groups.contains('dm_employee.group_hr_employee')) {
//       items.add(
//         _buildDashboardItem(
//           context,
//           Icons.access_time, // ⏱ Attendance icon
//           'Attendance',
//           AttendancePage(
//             isAdmin: widget.groups.contains('dm_employee.group_hr_admin'),
...
//         _buildDashboardItem(
//           context,
//           Icons.document_scanner, // 🏖 Leave icon
//           widget.groups.contains('dm_employee.group_hr_admin')
//               ? 'Applied Leaves'
//               : 'Apply Leave',
//           ApplyLeave(
//             userRole: widget.groups.contains('dm_employee.group_hr_admin')
//                 ? 'admin'
//                 : 'employee',
//             currentUserName: widget.name,
//           ),
...
//         _buildDashboardItem(
//           context,
//           Icons.assignment_turned_in, // 📑 Task icon
//           'Tasks',
//           Task(
...
//         _buildDashboardItem(
//           context,
//           Icons.people_alt, // 👥 Employees icon
//           'Employees',
//           const EmployeePage(),
//         ),
//       );
...
//         _buildDashboardItem(
//           context,
//           Icons.account_balance_wallet, // 💰 Payroll icon
//           'Payroll',
//           const PayrollPage(),
//         ),
//       );
...
//       child: InkWell(
//         borderRadius: BorderRadius.circular(16),
//         splashColor: const Color(0xFF073850).withOpacity(0.2),
...
//               mainAxisAlignment: MainAxisAlignment.center,
//               children: [
//                 Icon(icon, size: 36, color: const Color(0xFF073850)),
